# 06 — Diligence Tracker

**Property:** 426 Peachtree Drive, Rincon, GA 31326 · Parcel 0435A084
**Updated:** 2026-06-18 · Owner column = who must act

Status key: ✅ VERIFIED · 🟡 ESTIMATED/partial · 🔴 UNAVAILABLE (needs human action)
...
| 17 | 3 | Days-on-market / price history leverage | Listing | ✅ | — | 45 DOM + 1 price cut → buyer leverage. |

## Resolved
- #4 Flood (Zone X). #3 Water (regulated CWS, clean health record) — pending PWSID/tariff confirmation.

## Blocking the offer decision (must close before/at contract)
- #1 permits, #2 septic, #6 zoning, #12 appraisal-gap. These determine whether the apartment
  adds value/income or is a liability, and whether to offer $435k–$440k vs higher.
