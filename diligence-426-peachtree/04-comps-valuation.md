...
> Data-quality note: MLS (GAMLS/FMLS) is not public; **Redfin and qPublic blocked automated
> access** (403). The comps below are from public aggregator search results (Homes.com) and
> are **ESTIMATED** reference points, not a substitute for a licensed CMA or the VA
> appraisal. Treat $/sqft as directional. A buyer's-agent CMA pulling true Southern Hills /
...
|---|---|---|---|---|---|---|
| 112 Ramsey Way | 2026-05-04 | 5/3 | 2,325 | 2024 | $198 | ~$460,400 |
| 132 Crossing Cir | 2026-03-06 | n/a | n/a | n/a | $177 | — |
...
- **If the conversion is permitted** and counts as legitimate accessory living area + the
  ...
  **~$445,000–$460,000**. Gap risk: **low–moderate ($0–$15k).**
- **If the conversion is UNPERMITTED:** appraisers generally give **little or no value to
  unpermitted GLA**, and lenders may condition on legalization. Value reverts toward
...
home appraises below $459,900, VA issues a **Notice of Value at the appraised figure** and
the buyer must either (a) renegotiate price to appraised value, or (b) **bring cash for the
gap** (cannot be financed). See `05-financial-model.md` Grid D for equity-recovery timelines
at assumed true values of $430k/$440k/$450k.

## Recommended offer range (rationale)
...
concessions up to 4% — apply toward funding fee, prepaids, rate buydown).
